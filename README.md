...
* **I do it as a hobby:** I'm still in High School, without any experience in programming. But I will dedicate myself to the maximum in this project (and maybe in future projects), doing everything that is within my current reach. So, there will probably be inefficient, wrong or poorly done codes (If this happens, please comment on what should be improved!). All I want is to create something useful. :)
